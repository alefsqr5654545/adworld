...
<?php if( get_theme_mod('digital_marketing_lite_post') != ''){ ?>
	<section id="about_us">
	 	<div class="container">
			<?php
	          $postData =  get_theme_mod('digital_marketing_lite_post');
	         if($postData){
	          $args = array( 'name' => esc_html($postData ,'digital-marketing-lite'));
	          $query = new WP_Query( $args );
	          if ( $query->have_posts() ) :
	            while ( $query->have_posts() ) : $query->the_post(); ?>
		            <div class="row m-0">
		            	<div class="col-lg-7 col-md-6">
		                    ...
		                    <p><?php the_excerpt(); ?></p>
		                    <div class="more-btn">
	                      		<a href="<?php the_permalink(); ?>"><?php esc_html_e('View More','digital-marketing-lite'); ?></a>
		                    </div>
		                </div>
