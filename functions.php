...
function digital_marketing_lite_scripts() {
	...
	wp_enqueue_script( 'digital-marketing-lite-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );

	$digital_marketing_lite_l10n=array();
	
	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'digital-marketing-lite-navigation-jquery', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
		$digital_marketing_lite_l10n['expand']         = __( 'Expand child menu', 'digital-marketing-lite' );
		$digital_marketing_lite_l10n['collapse']       = __( 'Collapse child menu', 'digital-marketing-lite' );
	}
	...
	wp_localize_script( 'digital-marketing-lite-skip-link-focus-fix', 'digital_marketing_liteScreenReaderText', $digital_marketing_lite_l10n );
