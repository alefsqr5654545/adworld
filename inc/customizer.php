...
function digital_marketing_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('digital_marketing_lite_theme_options',array(
        'default' => __('Right Sidebar','digital-marketing-lite'),
...
final class Digital_Marketing_Lite_Customize {
		...
		$manager->add_section(
			new Digital_Marketing_Lite_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/themes/digital-marketing-wordpress-theme/' ),
				)
			)
		);
	}
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'digital-marketing-lite-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'digital-marketing-lite-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/css/customize-controls.css' );
	}
}
